...
export const WORKS = [
  {
    ...
    tags: ['UX/UI', '반응형 지원', 'Firebase', 'Kakao Maps'],
  ...
  },
  {
    ...
    tags: ['Branding', 'E-Commerce', 'React', 'GSAP', '반응형 지원'],
  ...
  },
  {
    ...
    tags: ['Interaction', 'GSAP ScrollTrigger', 'React', 'Motion', '반응형 미지원'],
  ...
  },
  {
    ...
    tags: ['Clone Coding', 'HTML/CSS', 'JavaScript', '반응형 지원'],
  ...
  },
  {
    ...
    tags: ['Interaction', 'GSAP ScrollTrigger', 'React', 'i18n', '반응형 미지원'],
